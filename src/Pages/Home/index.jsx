...
export const Home = () => {
  ...
  return (
    <section id="about">
      <div className="xl:h-screen lg:h-screen md:h-screen mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className=" xl:text-xl md:text-md sm:text-sm mb-8 leading-relaxed">
            ...
            reconversion professionnelle. J’aspire, à débuter ma nouvelle carrière de Développeur Web avec la volonté de participer à des projets
              <Typewriter
                options={{
          ...
          <div className="flex justify-center">
            <Link
              to="/contact"
              className="ml:2 inline-flex text-white bg-green-500 border-0 lg:py-2 lg:px-6 md:px-3 focus:outline-none hover:bg-green-600 rounded text-lg"
            >
